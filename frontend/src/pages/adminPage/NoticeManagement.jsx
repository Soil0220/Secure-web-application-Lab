...
/*
    공지사항 관리
    1. useInquiry를 통한 1:1문의 조회 및 답변 함수 등록
    2. useNotice를 통한 공지사항 조회 함수 등록
    3. tab을 통한 공지사항, 문의 탭 선택
    4. 공지사항 목록은 NoticeList 공통 컴포넌트사용
    5. isOpen을 통한 공지사항 모달 폼 ON/OFF
    6. 등록하기 버튼 클릭시 noticeForm을 통한 공지사항 등록 함수 실행 및 loading을 통한 요청대기
    7. 문의 클릭시 해당 문의에 대한 selectedQna, replyText 설정
    8. selectedQna 설정에 따른 1:1 문의 모달 폼 ON/OFF
...
const styles = {
    ...
    /* 탭 헤더 */
    tabHeader: { display: "flex", gap: "8px", borderBottom: "1px solid #e2e8f0", marginBottom: "20px" },
    tabBtn: { padding: "10px 18px", border: "none", backgroundColor: "transparent", cursor: "pointer", fontSize: "15px", fontWeight: "bold", color: "#666666", borderBottom: "2px solid transparent", transition: "all 0.15s ease" },
    tabActive: { color: "#0056b3", borderBottom: "2px solid #0056b3" },
    tabContent: { display: "flex", flexDirection: "column", gap: "16px" },

    /* 공지사항 탭 스타일 */
    noticeHeaderRow: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" },
    subText: { fontSize: "14px", color: "#666666" },
    noticeListWrapper: { width: "100%" },

    /* 민원 탭 (테이블 Card 형태) */
    tableCard: { backgroundColor: "#ffffff", borderRadius: "8px", border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 1px 3px rgba(0,0,0,0.03)" },
    ...
    trRow: { borderBottom: "1px solid #edf2f7", cursor: "pointer", transition: "background-color 0.15s ease" },
    td: { padding: "14px 16px", fontSize: "14px", verticalAlign: "middle", color: "#333333" },
    usernameText: { fontWeight: "bold", color: "#111111" },
    qnaTitle: { color: "#333333", fontWeight: "500" },
    ...
    /* 버튼 스타일 */
    primaryBtn: { backgroundColor: "#0056b3", color: "#ffffff", border: "none", padding: "9px 16px", borderRadius: "6px", fontSize: "14px", fontWeight: "bold", cursor: "pointer", transition: "background-color 0.15s ease" },
    primaryBtnModal: { width: "100%", backgroundColor: "#0056b3", color: "#ffffff", border: "none", padding: "11px 0", borderRadius: "6px", fontSize: "14px", fontWeight: "bold", cursor: "pointer" },
    ...
    pinnedBox: { backgroundColor: "#eef6ff", border: "1px solid #d0e2ff", borderRadius: "6px", padding: "10px 14px", marginBottom: "18px", width: "fit-content" },
    checkboxLabel: { display: "flex", alignItems: "center", gap: "8px", cursor: "pointer", fontSize: "13px", fontWeight: "bold", color: "#0056b3" },
    checkbox: { width: "16px", height: "16px", cursor: "pointer", accentColor: "#0056b3" },
    btnGroup: { display: "flex", marginTop: "20px" },

    /* 민원 답변 모달 */
    modalOverlay: { position: "fixed", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(0, 0, 0, 0.4)", backdropFilter: "blur(2px)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 9999 },
    modal: { backgroundColor: "#ffffff", borderRadius: "8px", width: "480px", padding: "24px", display: "flex", flexDirection: "column", gap: "18px", boxShadow: "0 10px 25px rgba(0, 0, 0, 0.15)", border: "1px solid #e2e8f0" },
    modalHeader: { borderBottom: "1px solid #e2e8f0", paddingBottom: "12px" },
    ...
    qnaInfoBox: { backgroundColor: "#f8f9fa", border: "1px solid #e2e8f0", borderRadius: "6px", padding: "12px 14px", display: "flex", flexDirection: "column", gap: "8px" },
    qnaMeta: { fontSize: "12px", color: "#666666" },
